function [S, runtime] = denoise_adaptive(I, ~)
%DENOISE_ADAPTIVE Adaptive semi-sparsity denoising.
%   S = DENOISE_ADAPTIVE(I) denoises image I using the adaptive
%   semi-sparsity method with spatially varying beta(x,y).
%
%   [S, RUNTIME] = DENOISE_ADAPTIVE(I) also returns wall-clock time.
%
%   This replicates the algorithm in run_semi_sparsity_adaptive.m.
