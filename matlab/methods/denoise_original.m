function [S, runtime] = denoise_original(I)
%DENOISE_ORIGINAL Original semi-sparsity denoising.
%   S = DENOISE_ORIGINAL(I) denoises image I using the original
%   semi-sparsity method (second-order L0 + first-order quadratic).
%
%   [S, RUNTIME] = DENOISE_ORIGINAL(I) also returns wall-clock time.
%
%   This replicates the algorithm in run_semi_sparsity.m.
